...
const NotFound = () => {
  return (
    <div className='twick'>
      <div class="wrapper"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080" style={{'width':"80%",'display':'flex','justifyContent':'center','marginLeft':'10%'}}>
  <title>404</title>
...
<div className='fjfj'>You’re either misspelling the URL
or requesting a page that's no longer here.👆</div>
    </div>
  )
}
